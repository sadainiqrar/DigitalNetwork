...
namespace DigitalNetwork.Models
{
    ...
    public partial class digimarketEntities1 : DbContext
    {
        ...
        public virtual int add_article(Nullable<int> aid, string article_url, Nullable<bool> status, Nullable<int> site_id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("add_article", aidParameter, article_urlParameter, statusParameter, site_idParameter);
        }
        ...
        public virtual int add_site(string site_name, string site, string gid, string email)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("add_site", site_nameParameter, siteParameter, gidParameter, emailParameter);
        }
        ...
        public virtual int delete_site(Nullable<int> site_id)
        {
            var site_idParameter = site_id.HasValue ?
                new ObjectParameter("site_id", site_id) :
                new ObjectParameter("site_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("delete_site", site_idParameter);
        }
        ...
        public virtual ObjectResult<get_admin_articles_Result> get_admin_articles()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<get_admin_articles_Result>("get_admin_articles");
        }
        ...
        public virtual ObjectResult<Nullable<int>> update_site(string site_name, string site, string gid, string email)
        {
            var site_nameParameter = site_name != null ?
                new ObjectParameter("site_name", site_name) :
                new ObjectParameter("site_name", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("update_site", site_nameParameter, siteParameter, gidParameter, emailParameter);
        }
