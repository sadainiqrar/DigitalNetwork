...
angular.module('DigitalMarket').controller('userMainController', function ($scope, sessionFactory, articleFactory, $rootScope, $cookies) {
    $rootScope.globals = $cookies.getObject('globals') || {};
		// create a message to display in our view
    $scope.userdate = $rootScope.globals.currentUserUser;
